...
x + y #output -> 5,7,7 adds the first 2 columns of both vectors and to maintain dimension it the lower dimension vector repeats it self with a warning
...
z[1, 1:2] #output would be 1st row completely
```
## Lists
...
- To reference data frame we use $ symbol in a similar manner of lists
```{r}
